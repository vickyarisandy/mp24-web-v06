...
class ExampleConversation extends Conversation
{
    ...
    {
        $question = Question::create("Silahkan pilih Keluhan..")
            ->fallback('Unable to ask question')
            ->callbackId('ask_reason')
            ->addButtons([
                Button::create('Dokter Umum')->value('dawud'),
                Button::create('Dokter Gigi')->value('bukhari'),
                // Button::create('Dokter Ibnu Majah')->value('majah'),
                // Button::create('Dokter Muslim')->value('muslim'),
                // Button::create('Dokter Nasai')->value('nasai'),
                // Button::create('Dokter Tirmidzi')->value('tirmidzi'),
            ]);
